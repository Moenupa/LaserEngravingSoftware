...
public class Tu_yuan implements Serializable {
   ...
   public static Tu_yuan fu_zhi(Tu_yuan ty) {
      Tu_yuan fh = chuang_jian(ty.lei_xing, ty.wei_tu);
   ...
   static void zhong_xin(List<Tu_yuan> sz) {
      ...
      for(int i = 0; i < Hua_ban.ty_shuzu.size(); ++i) {
         if (((Tu_yuan)Hua_ban.ty_shuzu.get(i)).xuan_zhong) {
            ((Tu_yuan)Hua_ban.ty_shuzu.get(i)).ping_yi((int)(x - (double)(rect.x + rect.width / 2)), (int)(y - (double)(rect.y + rect.height / 2)));
         }
      }
   ...
   public static Rectangle qu_jv_xing(List<Tu_yuan> sz) {
      ...
      for(int i = 0; i < sz.size(); ++i) {
         if (((Tu_yuan)sz.get(i)).xuan_zhong) {
            GeneralPath lu_jing3 = new GeneralPath(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).lu_jing);
            lu_jing3.transform(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).Tx);
   ...
   public static Tu_yuan chuang_jian(int leixing, BufferedImage wt) {
      ...
      case 1:
         ...
         ty.lu_jing.moveTo(0.0F, 0.0F);
         ty.lu_jing.lineTo((float)wt.getWidth(), 0.0F);
         ty.lu_jing.lineTo((float)wt.getWidth(), (float)wt.getHeight());
         ty.lu_jing.lineTo(0.0F, (float)wt.getHeight());
         ty.lu_jing.closePath();
         break;
      case 2:
         ty.lei_xing = 0;
   ...
   public static void qu_jvxing(List<Tu_yuan> sz) {
      ...
      for(i = 1; i < Hua_ban.ty_shuzu.size(); ++i) {
         if (((Tu_yuan)Hua_ban.ty_shuzu.get(i)).lei_xing == 0) {
            lu_jing3 = new GeneralPath(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).lu_jing);
            lu_jing3.transform(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).Tx);
   ...
   public static void hui_fu() {
      GeneralPath lu_jing3 = new GeneralPath(((Tu_yuan)Hua_ban.ty_shuzu.get(0)).lu_jing);
      lu_jing3.transform(((Tu_yuan)Hua_ban.ty_shuzu.get(0)).Tx);
   ...
   public static BufferedImage qu_tu(List<Tu_yuan> sz) {
      ...
      for(int i = 1; i < Hua_ban.ty_shuzu.size(); ++i) {
         if (((Tu_yuan)Hua_ban.ty_shuzu.get(i)).lei_xing == 1 && ((Tu_yuan)Hua_ban.ty_shuzu.get(i)).chuli_fs != 3) {
            GeneralPath lu_jing2 = new GeneralPath(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).lu_jing);
            lu_jing2.transform(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).Tx);
            Rectangle jx = lu_jing2.getBounds();
            g2D.drawImage(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).qu_tu(), jx.x, jx.y, (ImageObserver)null);
            you = true;
         }
      }
   ...
   public static BufferedImage qu_tu_sl(List<Tu_yuan> sz) {
      ...
      for(int i = 1; i < Hua_ban.ty_shuzu.size(); ++i) {
         GeneralPath lu_jing4 = new GeneralPath(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).lu_jing);
         lu_jing4.transform(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).Tx);
         if (((Tu_yuan)Hua_ban.ty_shuzu.get(i)).lei_xing == 0) {
   ...
   public static BufferedImage qu_tu_sl_tc(List<Tu_yuan> sz) {
      ...
      for(int i = 1; i < Hua_ban.ty_shuzu.size(); ++i) {
         GeneralPath lu_jing4 = new GeneralPath(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).lu_jing);
         lu_jing4.transform(((Tu_yuan)Hua_ban.ty_shuzu.get(i)).Tx);
         if (((Tu_yuan)Hua_ban.ty_shuzu.get(i)).lei_xing == 0 && ((Tu_yuan)Hua_ban.ty_shuzu.get(i)).tian_chong) {
            g2D.setColor(Color.BLACK);
