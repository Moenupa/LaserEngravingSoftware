...
public class Hua_ban extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        for (int i = 0; i < ty_shuzu.size(); ++i) {
            GeneralPath lu_jing2 = new GeneralPath(((Tu_yuan) ty_shuzu.get(i)).path);
            ...
            if (i != 0) {
                ...
                if (((Tu_yuan) ty_shuzu.get(i)).fill) {
                    g2D.fill(lu_jing2);
                }
    ...
    Point2D zhuan_huan(Point2D m) {
        GeneralPath lu_jing2 = new GeneralPath(((Tu_yuan) ty_shuzu.get(0)).path);
    ...
    public void di_tu() {
        ...
        for (j = 0; j < gao + 1; ++j) {
            if (j == 0 || j % 5 == 0 || j == gao) {
                ty.path.moveTo(0.0D, (double) j / fen_bian_lv);
                ty.path.lineTo((double) kuan / fen_bian_lv, (double) j / fen_bian_lv);
            }
        }

        for (j = 0; j < kuan + 1; ++j) {
            if (j == 0 || j % 5 == 0 || j == kuan) {
                ty.path.moveTo((double) j / fen_bian_lv, 0.0D);
                ty.path.lineTo((double) j / fen_bian_lv, (double) gao / fen_bian_lv);
            }
        }
