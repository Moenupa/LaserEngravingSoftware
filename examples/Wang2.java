...
public class Wang2 {
    ...
    public void xin_tiao() {
        Runnable runnable2 = new Runnable() {
            public void run() {
                while (true) {
                    if (!Hua_ban.kuang && !mainJFrame.kai_shi && !Wang2.this.xie2(new byte[]{11, 0, 4, 0}, 100)) {
                        try {
                            Thread.sleep(100L);
                    ...
                    if (Wang2.this.bt != null) {
                        ...
                        while (true) {
                            ...
                            if (Wang2.this.lianjie(new byte[]{10, 0, 11, 0, 0, 0, 0, 0, 0, 0, 0}, 100)) {
                                ...
                                Hua_ban.fen_bian_lv = 0.05D + (double) Wang2.this.fbl.getSelectedIndex() * 0.0125D;
                                Wang2.this.hb.di_tu();
